...
extension UIButton {
    ...
    func setButtonWithTitel(image: UIImage, selectedImage: UIImage)
    {
        setImage(image.withRenderingMode(.alwaysOriginal).withTintColor(UIColor.darkGray), for: .normal)
        setImage(selectedImage.withRenderingMode(.alwaysOriginal).withTintColor(UIColor.mainColor), for: .selected)
